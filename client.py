...
a = 123546978  # по варианту публичный ключ первого пользователя s_public
x = 1278 # по варианту приватный ключ первого пользователя  s _private
b = 123978  # по варианту публичный ключ второго пользователя m_public
y = 6978  # по варианту приватный ключ второго пользователя m _private
k1 = 1 # по варианту
k2 = 1 # по варианту
